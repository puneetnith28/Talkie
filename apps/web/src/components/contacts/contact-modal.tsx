...
import { Users, Loader2, AlertCircle, MessageCircle, Send } from 'lucide-react';
...
export function ContactModal({
  ...
  const [whatsappId, setWhatsappId] = useState(existingContact?.whatsappId || '');
  const [telegramUsername, setTelegramUsername] = useState(existingContact?.telegramUsername || '');
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white tracking-tight">
                {existingContact ? 'Edit Contact Profile' : 'Create Omnichannel Contact'}
              </h3>
              <p className="text-xs text-neutral-400">Bind phone, WhatsApp, and Telegram identities</p>
            </div>
          </div>
          <button
            onClick={onClose}
