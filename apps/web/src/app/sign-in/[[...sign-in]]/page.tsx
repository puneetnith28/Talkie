        ...
        {hasClerkKey ? (
          ...
          <Card className="w-full p-8 bg-[#0a0c10]/90 border border-white/[0.1] backdrop-blur-2xl shadow-2xl space-y-6">
            <div className="text-center space-y-2">
              ...
              <h1 className="text-xl font-bold text-white tracking-tight">Welcome to Talkie</h1>
              <p className="text-xs text-neutral-400 max-w-xs mx-auto">
                Sign in to manage carrier phone numbers, AI voice agents, and real-time audio streams.
              </p>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.08] text-xs space-y-2">
              ...
              <p className="text-[11px] text-neutral-400 leading-relaxed">
                Clerk keys are in sandbox mode. You can instantly access the developer console with full enterprise telephony simulation.
              </p>
            </div>
